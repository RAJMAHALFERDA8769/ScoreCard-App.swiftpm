        ...
        VStack {
            ...
            ForEach(players.wrappedValue.indices, id: \.self) { index in
                ...
                HStack {
                    Text(player.name)
                        .frame(width: 80)
                    TextField("Pts", value: player.points, formatter: NumberFormatter())
                        .frame(width: 40)
                        .textFieldStyle(RoundedBorderTextFieldStyle())
                    TextField("Ast", value: player.assists, formatter: NumberFormatter())
                        .frame(width: 40)
                        .textFieldStyle(RoundedBorderTextFieldStyle())
                    TextField("Reb", value: player.rebounds, formatter: NumberFormatter())
                        .frame(width: 50)
                        .textFieldStyle(RoundedBorderTextFieldStyle())
                    TextField("Stl", value: player.steals, formatter: NumberFormatter())
                        .frame(width: 35)
                        .textFieldStyle(RoundedBorderTextFieldStyle())
                    TextField("Blk", value: player.blocks, formatter: NumberFormatter())
                        .frame(width: 35)
                        .textFieldStyle(RoundedBorderTextFieldStyle())
                }
            }
